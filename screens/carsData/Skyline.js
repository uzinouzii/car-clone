...
const Skyline = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>Nissan Skyline R35 </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>Nissan Skyline R35 in detail</Text>
