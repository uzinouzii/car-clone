...
const Lambo = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>Lamborghini Hurican </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>Lamborghini Hurican in detail</Text>
