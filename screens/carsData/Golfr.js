...
const Golfr = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>Volkswagen Golf R </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>Volkswagen Golf R in detail</Text>
