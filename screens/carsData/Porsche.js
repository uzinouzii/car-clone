...
const Porsche = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>Porsche 911 </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>Porsche 911 in detail</Text>
