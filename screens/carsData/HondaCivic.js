...
const HondaCivic = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>Honda Civic Type r </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>Honda Civic Type r in detail</Text>
