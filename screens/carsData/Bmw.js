...
const Bmw = () => {
  return (
    <ScrollView style ={styles.container}>
     ...
     <View>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 20, paddingTop: 20}}>BMW  F80 M3 </Text>
    ...
    <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 20}}>BMW M3 in detail</Text>
