...
const Centraldrive = ({navigation}) => {
  return (
    <ScrollView style ={styles.container}>
      <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 25, paddingLeft: 100, paddingTop: 20}}> Central London Drive  </Text>
      <Image style = {styles.top}
        source ={require('../../assets/Centraldrive.png')}>
    </Image>
    <View style = {styles.showDetailcontainer}>
     <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 15, paddingBottom: 8, }}> 29th May 2022 </Text>
    ...
    <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 15, paddingBottom: 8}}> Central London </Text>
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingBottom: 8}}> W1A 0AA </Text>
    </View>
    ...
    <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 5, paddingBottom: 8}}> 1000 people attending </Text>
    ...
    <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 85, paddingTop: 10, paddingBottom: 8}}> Cloudy </Text>
    </View>

    <View style = {styles.showDetail}>
       <Text style = {{color: 'white', fontSize: 20, paddingLeft: 10, paddingTop: 20 ,fontWeight: 'bold',}}>Neareast Fuel station </Text>
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 15, paddingBottom: 8}}> Shell Garage </Text>
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15,  paddingBottom: 8}}> 4.6 miles </Text>
    </View>
