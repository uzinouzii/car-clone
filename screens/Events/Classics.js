...
const Classics = ({navigation}) => {
  return (
    <ScrollView style ={styles.container}>
      <Text style = {{color: 'white', fontWeight: 'bold', fontSize: 25, paddingLeft: 100, paddingTop: 20}}>  Classics car show  </Text>
      <Image style = {styles.top}
        source ={require('../../assets/Classicsmeet.png')}>
    </Image>
    <View style = {styles.showDetailcontainer}>
     <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 15, paddingBottom: 8, }}> 5th May 2022 </Text>
    ...
    <View style = {styles.showDetail}>
       ...
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingTop: 5, paddingBottom: 8}}> 200 people attending </Text>
       <Text style = {{color: 'white', fontSize: 15, paddingLeft: 15, paddingBottom: 8}}> 300 people intersted </Text>
    </View>
